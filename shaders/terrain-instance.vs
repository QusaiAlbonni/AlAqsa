...
uniform mat4 instances[NUM_OF_INSTANCES];
...
void main()
{
    ...
    fragPos = vec3(instances[gl_InstanceID] * vec4(aPos, 1.0)); 
    data_out.Normal = aNormal;
	data_out.texCoord = aTexCoords;
	data_out.projection = projection * view;
	data_out.model = instances[gl_InstanceID];
