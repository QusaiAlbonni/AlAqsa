...
void addSpotLight(Shader lightingShader, glm::vec3 lightPos = glm::vec3(camera.Position.x, camera.Position.y, camera.Position.z), glm::vec3 direction = camera.Front);
