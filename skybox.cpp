...
unsigned int initSkyBoxTexturesNight() {
    std::vector<std::string> faces
    {
        "res/textures/skybox/night/right.jpg",
        "res/textures/skybox/night/left.jpg",
        "res/textures/skybox/night/top.jpg",
        "res/textures/skybox/night/bottom.jpg",
        "res/textures/skybox/night/front.jpg",
        "res/textures/skybox/night/back.jpg"
    };
    unsigned int cubemapTexture = loadCubemap(faces);
    return cubemapTexture;
}
