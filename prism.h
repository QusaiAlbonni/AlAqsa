...
void generatePrism(std::vector<sVertex>& vertices, std::vector<unsigned int>& indices, const int sides) {
...
void buildCircle(vector<sVertex> &vertices,vector<unsigned int> &indices, float radius, int vCount)
{
...
void generateCylinder(float radius, float height, int sectors, int stacks,
